<?php 
    ...
    $sql = "select * from interested_user_properties iup 
...
<html>
    <head>
        ...
        <meta name="description" content="this website is used to the details of the Property">
        <meta charset="UTF-8">
        <link rel="stylesheet" href="pg-life-property-detail-css.css"/>
  ...
  <div class="space"></div>
        ...
        <div class="b" style="padding-bottom:15px;">
            <div style="display: flex;align-items: center;" class="pixels"><a href="index.php" style="text-decoration: none;"><p class="p1">Home</p></a>
            <p class="slash">/</p>
            <a href="pg-life-property-list-mumbai.php" style="text-decoration: none;"><p style="margin-left: 10px;" class="p1">Mumbai</p></a></div>
            <div style="display: flex;width: 100%;align-items: center;justify-content: flex-start;height: 20px;"><p class="slash">/</p>
            <p class="Guest">Navkar Paying Guest</p></div>
        </div>

        <div class="c">
            <img src="1d4f0757fdb86d5f.jpg" class="i4"/>
        </div>
            ...
            <div class="dv3">
                ...
                <div class="dv4">
                  <div style=" width: 100%;display: flex;justify-content: space-between;">
                    ...
                    <div>
                        <i class="far fa-heart" style="color: red;font-size: 22px; padding-right: 50px;" aria-hidden="true" id="heart"></i>
                    </div>    
                  </div>
                  <div style="width: 100%;">
                    <b class="navkar">Navkar Paying Guest</b>
                    <p class="address">44, Juhu Scheme, Juhu, Mumbai, Maharashtra 400058</p>
                    <img src="male.png" class="gender" />
                  </div>
                  <div class="bottom">
                    <p><b class="rate">Rs 9,500/-</b> per person</p>
        ...
        <div class="e">
                <div class="e1">
                    <b style="font-size: 30px;">Amenities</b>
                </div>
                <div class="e2">
                    <div class="e21">
                        <p style="font-size: 20px;">Building</p>
                        <div style="display: flex;gap: 10px;margin-top:10px ;align-items: center;"><img src="powerbackup.svg" style="margin: 0px;"/><p>Power backup</p></div>
                        <div style="display: flex;gap: 10px;align-items: center;"><img src="fireext.svg" style="margin: 0px;"/><p>Fire Extinguisher</p></div>
                        <div style="display: flex;gap: 10px;align-items: center;"><img src="lift.svg" style="margin: 0px;"/><p>Lift</p></div>
                        <div style="display: flex;gap: 10px;align-items: center;"><img src="cctv.svg" style="margin: 0px;"/><p>CCTV</p></div>
                    </div>
                    <div class="e21">
                        <p style="font-size: 20px;">Common Area</p>
                        <div style="display: flex;gap: 10px;margin-top:10px ;align-items: center;"><img src="wifi.svg" style="margin: 0px;"/><p>WIFI</p></div>
                        <div style="display: flex;gap: 10px;align-items: center;"><img src="tv.svg" style="margin: 0px;"/><p>TV</p></div>
                        <div style="display: flex;gap: 10px;align-items: center;"><img src="rowater.svg" style="margin: 0px;"/><p>Water Purifier</p></div>
                        <div style="display: flex;gap: 10px;align-items: center;"><img src="dining.svg" style="margin: 0px;"/><p>Dining</p></div>
                        <div style="display: flex;gap: 10px;align-items: center;"><img src="washingmachine.svg" style="margin: 0px;"/><p>Washing Machine</p></div>
                    </div>
                    <div class="e21">
                        <p style="font-size: 20px;">Bedroom</p>
                        <div style="display: flex;gap: 10px;margin-top:10px ;align-items: center;"><img src="bed.svg" style="margin: 0px;"/><p>Bed with Mattress</p></div>
                    </div>
                    <div class="e21">
                        <p style="font-size: 20px;">Washroom</p>
                        <div style="display: flex;gap: 10px;margin-top:10px ;align-items: center;"><img src="geyser.svg" style="margin: 0px;"/><p>Geyser</p></div>
                    </div>
                </div>
        </div>      
        ...
        <div class="g">
           <div class="g1"> 
            <h1 class="header1">About the Property</h1>
            <p style="margin-top: 30px;" class="matter">Furnished studio apartment - share it with close friends! Located in posh area of Bijwasan in Delhi, this house is available for both boys and girls. Go for a private room or opt for a shared one and make it your own abode. Go out with your new friends - catch a movie at the nearest cinema hall or just chill in a cafe which is not even 2 kms away. Unwind with your flatmates after a long day at work/college. With a common living area and a shared kitchen, make your own FRIENDS moments. After all, there's always a Joey with unlimited supply of food. Remember, all it needs is one crazy story to convert a roomie into a BFF. What's nearby/Your New Neighborhood 4.0 Kms from Dwarka Sector- 21 Metro Station.</p>
        </div></div>
    ...
    <div class="h">
       <div class="h1"> 
        <div class="opinion">
        <h1 style="font-weight: 500px;" class="what"><b>What people say</b></h1></div>
        <div class="main">
            <div class="quote"> 
                <div style="display: flex;align-items: center;justify-content: center;">
                  <img class="i7" src="man.png">
                </div>
                <div class="text">
                    <i class="fa fa-quote-left" style="position: absolute;left: 5px;top: 0px;font-size: 30px;"></i>
            ...
            <div class="person">
                <div style="gap: 50px;"><b>- Ashutosh Gowariker</b></div>
            </div>
        </div>
        <div class="main">
            <div class="quote"> 
            ...
            <div class="person">
                <div style="gap: 50px;"><b>-  Karan Johar</b></div>
            </div>
        </div>
        </div>
    </div>
