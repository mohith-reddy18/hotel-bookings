...
<html>
    <head>
        <title>Property list Hyderabad</title>
        <meta name="viewport" content="width=device-width,initial-scale=1">
        <meta name="description" content="PGLife is a website build to help users to book there interested rooms in the city Hyderabad">
        <meta charset="UTF-8">
        ...
        <div class="b">
            ...
            <div class="di3">
                ...
                <div class="div4">
                  ...
                  <div style="margin-top: 0px;">
                    ...
                    <p style="opacity: 0.5;margin-bottom: 0px;">10-4-06, Humayun Nagar Rd, Masab Tank, Hyderabad, Telangana 500028</p>
            ...
            <div class="di3">
                ...
                <div class="div4">
                  ...
                  <div style="margin-top: 0px;">
                    <b>Prowell hotels</b>
                    <p style="opacity: 0.5;margin-bottom: 0px;">Prowell Hotels (Crown ), Behind medicover hospitals Patrika Nagar lane 5,Hitech city, Madhapur, Hyderabad, Telangana 500081</p>
                    <img src="male.png" style="width: 40px;" />
                  </div>
                  <div class="view">
                    <p><b class="rate">Rs 5,000/-</b> per person</p>
                    <a href="pg-life-property-detail.php" style="text-decoration: none;"><button class="button">View</button></a>
                  </div>
                </div>
            </div>
            ...
            <div class="di3">
                ...
                <div class="div4">
                  ...
                  <div style="margin-top: 0px;">
                    <b>Exotica PG for Women</b>
                    <p style="opacity: 0.5;margin-bottom: 0px;font-size: 15px;">Plot no 95, opposite to BLOCK-A, behind Hotel Big Bowl, Hanuman Nagar, Kondapur, Hyderabad, Telangana 500084</p>
