...
<html>
    <head>
        <title>Property list Mumbai</title>
        <meta name="viewport" content="width=device-width,initial-scale=1">
        <meta name="description" content="PGLife is a website build to help users to book there interested rooms in the city Mumbai">
        <meta charset="UTF-8">
        ...
        <div class="b">
            ...
            <div class="di3">
                ...
                <div class="div4">
                  ...
                  <div style="margin-top: 0px;">
                    <b>Navkar Paying Guest</b>
                    <p style="opacity: 0.5;margin-bottom: 0px;">44, Juhu Scheme, Juhu, Mumbai, Maharashtra 400058</p>
            ...
            <div class="di3">
                ...
                <div class="div4">
                  ...
                  <div style="margin-top: 0px;">
                    <b>Ganpati Paying Guest</b>
                    <p style="opacity: 0.5;margin-bottom: 0px;">Police Beat, Sainath complex, Besides, SV Rd, Daulat Nagar, Borivali East, Mumbai-400066</p>
                    <img src="unisex.png" style="width: 40px;" />
                  </div>
                  <div class="view">
                    <p><b class="rate">Rs 8,000/-</b> per person</p>
                    <a href="pg-life-property-detail.php" style="text-decoration: none;"><button class="button">View</button></a>
                  </div>
                </div>
            </div>
            ...
            <div class="di3">
                ...
                <div class="div4">
                  ...
                  <div style="margin-top: 0px;">
                    <b>PG for Girls Borivali West</b>
                    <p style="opacity: 0.5;margin-bottom: 0px;font-size: 15px;">Plot no.258/D4, Gorai no.2, Borivali West, Mumbai, Maharashtra 400092</p>
                    <img src="female.png" style="width: 40px;" />
                  </div>
                  <div class="view">
                    <p><b class="rate">Rs 8,500/-</b> per person</p>
                    <a href="pg-life-property-detail.php" style="text-decoration: none;"><button class="button">View</button></a>
                  </div>
                </div>
            </div>
